...
const navItems = [
  { to: '/provider/verify', label: 'Verify Member' },
  { to: '/provider/claim', label: 'Submit Claim' },
  { to: '/provider/preauth', label: 'Pre-Authorization' },
  { to: '/provider/history', label: 'Transaction History' },
]
</script>
